    ...
    for epoch in range(epoch_0,epochs):
        ...
        if rank == n_ka:
            ...
            if epoch % 5 == 0:
                ...
                torch.save(checkpoint, f'../../model/text/checkpoint{epoch}.pth')
            save_path = os.path.join('../../model/text', f'S4_fs4d_epoch_{epoch + 1}.pth')
            torch.save(model.module.state_dict(), save_path)
            loss_path = os.path.join('../../model/text', f'S4_fs4d_loss.pth')
